...
<td>
  <img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_flash.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="(isAllowed()) ? showMenu('mediaMenu',110,178) : foo.focus()" class=toolbutton title="<?php echo sTxtFlash; ?>"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>

<?php if($this->__hideImage != true) { ?>
<td>
  <img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_image.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="(isAllowed()) ? showMenu('imageMenu',98,68) : foo.focus()" class=toolbutton title="<?php echo sTxtImage; ?>"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<!--td>
...
<table border="0" cellspacing="0" cellpadding="3" width="98" style="BORDER-LEFT: buttonhighlight 1px solid; BORDER-RIGHT: buttonshadow 2px solid; BORDER-TOP: buttonhighlight 1px solid; BORDER-BOTTOM: buttonshadow 1px solid;" bgcolor="threedface" bgcolor="threedface">
  <tr onClick ='parent.doImageInsert();'> 
<td style="cursor:hand; font:8pt tahoma; BORDER-LEFT: threedface 1px solid; BORDER-RIGHT: threedface 1px solid; BORDER-TOP: threedface 1px solid; BORDER-BOTTOM: threedface 1px solid;" onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);">
...
<table border="0" cellspacing="0" cellpadding="3" width="110" style="BORDER-LEFT: buttonhighlight 1px solid; BORDER-RIGHT: buttonshadow 2px solid; BORDER-TOP: buttonhighlight 1px solid; BORDER-BOTTOM: buttonshadow 1px solid;" bgcolor="threedface" bgcolor="threedface">

  <tr onClick ='parent.doFlashUpload();'> 
<td style="cursor:hand; font:8pt tahoma; BORDER-LEFT: threedface 1px solid; BORDER-RIGHT: threedface 1px solid; BORDER-TOP: threedface 1px solid; BORDER-BOTTOM: threedface 1px solid;" onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);">
  &nbsp; &nbsp; &nbsp;<?php echo sTxtFlashUpload; ?>...&nbsp;</td>
  </tr>
  <tr onClick ='parent.doFlashResource();'> 
<td style="cursor:hand; font:8pt tahoma; BORDER-LEFT: threedface 1px solid; BORDER-RIGHT: threedface 1px solid; BORDER-TOP: threedface 1px solid; BORDER-BOTTOM: threedface 1px solid;" onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);">
  &nbsp; &nbsp; &nbsp;<?php echo sTxtFlashResource; ?>...&nbsp;</td>
  </tr>
...
<td style="cursor:hand; font:8pt tahoma; BORDER-LEFT: threedface 1px solid; BORDER-RIGHT: threedface 1px solid; BORDER-TOP: threedface 1px solid; BORDER-BOTTOM: threedface 1px solid;" onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);">
  ...
  <tr onClick ='parent.doAttachResource();'> 
<td style="cursor:hand; font:8pt tahoma; BORDER-LEFT: threedface 1px solid; BORDER-RIGHT: threedface 1px solid; BORDER-TOP: threedface 1px solid; BORDER-BOTTOM: threedface 1px solid;" onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);">
  &nbsp; &nbsp; &nbsp;<?php echo sTxtAttachResource; ?>...&nbsp;</td>
  </tr>
...
<td style="cursor:hand; font:8pt tahoma; border: threedface 1px solid;" onMouseOver="parent.contextHilite(this);" onMouseOut="parent.contextDelite(this);">
  &nbsp; &nbsp; &nbsp;<?php echo sTxtCut; ?>&nbsp;</td>
  </tr>
