...
/**
* @package cwps.oas
* $Id: SoapOAS.class.php,v 1.1 2006/07/16 07:38:02 Administrator Exp $
*/
define("SOAP_OK", 0);
	...
	*/
	function SoapOAS($server_address)
	{
		...
		$this->ActionReqTpl = 
							...
							."<SOAP-ENV:Header>"
							."    <TransactionID xmlns=\"http://www.cmsware.net/passport/schemas/\">{TransactionID}</TransactionID>"
							."    <TransactionAccessKey xmlns=\"http://www.cmsware.net/passport/schemas/\">{TransactionAccessKey}</TransactionAccessKey>"
							."</SOAP-ENV:Header>"
							."<SOAP-ENV:Body>"
							."<ActionReq xmlns=\"http://www.cmsware.net/passport/schemas/\">"
