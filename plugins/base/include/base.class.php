...
class Base extends iData {
	...
	{
		global $table, $plugin_table, $db_config, $db, $iWPC;
	...
	{
		global $table, $plugin_table, $db_config, $db, $iWPC,$CONTENT_MODEL_INFO;
	...
	{
		global $table, $plugin_table, $db_config, $db;
		$where = " CreationDate > ".strtotime($_start_time)." AND CreationDate < ".(strtotime($_end_time) + 3600*24);
