...
$install_sql = <<<EOT
CREATE TABLE IF NOT EXISTS {$table_header}plugin_fulltext_fields (
...
INSERT INTO {$table_header}plugin_fulltext_fields VALUES ('', 'Content', 'Content', 1);
INSERT INTO {$table_header}plugin_fulltext_fields VALUES ('', 'Main', 'Title,Content', 1);



CREATE TABLE IF NOT EXISTS {$table_header}plugin_fulltext_search_1 (
...
CREATE TABLE IF NOT EXISTS {$table_header}plugin_fulltext_setting (
