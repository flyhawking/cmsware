...
class PluginSetting extends iData {
	...
	{
		global $plugin_table,$db,$table,$db_config;
	...
	{
		global $plugin_table, $table, $db, $db_config;
...
/*ALTER TABLE `cmsware_deploy_search_1` ADD FULLTEXT Title_Content(
Title,
Content
) 
*/
